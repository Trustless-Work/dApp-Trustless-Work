...
**IMPORTANT TO KNOW:**
-> If you're using the develop enviroment "https://dev.api.trustlesswork.com", you have to request the API Key in [development dApp](https://dapp.dev.trustlesswork.com)
