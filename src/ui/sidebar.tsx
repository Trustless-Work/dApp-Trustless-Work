...
>(
  (
    ...
    const isExpandedOnDesktop = isHovered || expandLockCount > 0;
    const displayState =
      !isMobile && isExpandedOnDesktop
        ? "expanded"
        : isMobile
          ? state
          : "collapsed";
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 hidden h-svh w-[--sidebar-width] transition-[left,right,width,z-index] ease-linear md:flex",
            isHovered || expandLockCount > 0 ? "z-30" : "z-10",
            side === "left"
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[state=collapsed]:w-[--sidebar-width-icon] overflow-hidden",
            className,
          )}
          {...props}
        >
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col overflow-auto group-data-[state=collapsed]:overflow-hidden",
        className,
      )}
      {...props}
    />
