...
export const Lights = ({ className }: BackgroundLightsProps) => {
  return (
    <div className={cn("fixed inset-0 z-[-2] pointer-events-none", className)}>
      ...
      <motion.div
        style={{ backgroundColor: "rgba(59, 130, 246, 0.03)" }} // primary: blue-500 aprox
      ...
      {/* Secondary light */}
      <motion.div
        style={{ backgroundColor: "rgba(96, 165, 250, 0.03)" }} // blue-400
      ...
      {/* Accent light */}
      <motion.div
        style={{ backgroundColor: "rgba(192, 132, 252, 0.03)" }} // purple-400
      ...
      {/* Right-side light */}
      <motion.div
        style={{ backgroundColor: "rgba(52, 211, 153, 0.03)" }} // emerald-400
