              ...
              <div 
                ...
                className={cn(
                 ...
                 "before:absolute before:left-5 before:top-[2.9rem] before:h-[calc(100%-2rem)] before:w-[2px]",
                  isCompleted ? "before:bg-blue-500" : "before:bg-zinc-200 dark:before:bg-zinc-800",
              ...
              >
                <button
                  ...
                  className={cn(
                    ...
                    isCompleted ? "border-blue-500 bg-blue-500" : "border-zinc-200 dark:border-zinc-800",
                ...
                >
                  <span className={cn(
                    "text-sm font-medium",
                    isCompleted ? "text-white" : isActive ? "text-blue-500" : "text-zinc-500 dark:text-zinc-400"
                  )}>
                    {stepNumber}
                  </span>
                </button>
                ...
                <div className="flex-1 flex items-start gap-6">
                  ...
                  <div className="flex items-center pt-2">
                    {Array.from({ length: 5 }).map((_, nodeIndex) => {
                      ...
                      const isProgressActive = progressNumber <= currentProgress;
                          ...
                          {nodeIndex < 4 && (
                            <div className="relative w-12 h-0.5 bg-zinc-200 dark:bg-zinc-800">
                              <div
                                ...
                                style={{
                                  width: progressNumber < currentProgress ? "100%" : "0%"
                                }}
                              />
                            </div>
                          )}
